...
timeline.append({"start_sample": 0, "length": SAMPLE_RATE * 1, "base_freq": "D", "key": 1, "harmonic_steps": 2, "wave_shape": "saw", "envelope": adsr_envelope, "velocity": .7, "combine": COMBINE_SUB, "echo": (0, SAMPLE_RATE * .5, SAMPLE_RATE * 0.25, 0.99999)})
timeline.append({"start_sample": 0, "length": SAMPLE_RATE * 1, "base_freq": "F", "key": 2, "harmonic_steps": 3, "wave_shape": "sine", "envelope": adsr_envelope, "velocity": .65, "combine": COMBINE_ADD, "echo": (0, SAMPLE_RATE * .15, SAMPLE_RATE * 0.25, 0.9999)})
