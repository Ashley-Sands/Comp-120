...
timeline.append({"start_sample": 0, "length": SAMPLE_RATE * 10, "base_freq": "D", "key": 2, "harmonic_steps": 3, "wave_shape": "saw", "envelope": adsr_long_envelope, "velocity": .2, "combine": COMBINE_ADD, "echo": (0, SAMPLE_RATE * .5, SAMPLE_RATE * 0.25, 0.99999)})

timeline.append({"start_sample": 0, "length": SAMPLE_RATE * 6, "base_freq": "F", "key": 1, "harmonic_steps": 3, "wave_shape": "triangle", "envelope": adsr_long_envelope, "velocity": 1, "combine": COMBINE_ADD, "echo": (0, SAMPLE_RATE * .5, SAMPLE_RATE * 0.75, 0.9999)})
timeline.append({"start_sample": 0, "length": SAMPLE_RATE * 1, "base_freq": "D", "key": 2, "harmonic_steps": 3, "wave_shape": "sine", "envelope": adsr_long_envelope, "velocity": .7, "combine": COMBINE_SUB, "echo": (0, SAMPLE_RATE * .25, SAMPLE_RATE * 0.75, 0.99999)})
